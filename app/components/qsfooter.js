  ...
  render(){
    return (
      <div className="qsfooter">
        ...
        <div onTouchEnd={this.gotoPage.bind(this, "focus")} className={this.props.page == "focus" ? "footer-item active" : "footer-item"}><img src={this.props.page == "focus" ? "./images/focus_1.png" : "./images/focus.png"} /><div>专家</div></div>
